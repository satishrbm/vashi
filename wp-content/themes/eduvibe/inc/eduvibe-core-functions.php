		...
		if ( ! empty( $description ) ) :
			echo '<div class="eduvibe-author-bio">';
				echo '<div class="eduvibe-author-thumb">';
				    echo '<a href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'eduvibe_author_thumb_size', 500 ) ) . '</a>';
				echo '</div>';
