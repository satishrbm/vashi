 ...
 * @since 1.0.0
 */
class Team_One extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Team / Instructor 1( Grid / Carousel )', 'eduvibe-core' );
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'container', 'class', 'eduvibe-team-one-wrapper' );
        $this->add_render_attribute( 'container', 'class', 'eduvibe-team-one-' . esc_attr( $settings['display_type'] ) );
        $this->add_render_attribute( 'single-wrapper', 'class', 'eduvibe-team-one-single-' . esc_attr( $settings['display_type'] ) );
            ...
            echo '<div ' . $this->get_render_attribute_string( 'container' ) . '>';
                foreach ( $members as $key => $member ) :
                    ...
                    echo '<div ' . $this->get_render_attribute_string( 'single-wrapper' ) . '>';
                        echo '<div class="edu-instructor-grid edu-instructor-1">';
