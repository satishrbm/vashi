 ...
 * EduVibe Core
 *
 * Elementor widget for testimonial three.
 *
 * @since 1.0.0
 */
class Testimonial_Three extends Widget_Base {
    ...
    public function get_name() {
        return 'eduvibe-testimonial-carousel-three';
    }
    ...
    public function get_title() {
        return __( 'Testimonial Carousel 3', 'eduvibe-core' );
    }
    ...
    protected function render() {
        ...
        echo '<div class="edu-testimonial-activation testimonial-item-3 edu-slick-button">';
            foreach ( $testimonials as $key => $testimonial ) :
                ...
                echo '<div class="testimonial-card-box">';
