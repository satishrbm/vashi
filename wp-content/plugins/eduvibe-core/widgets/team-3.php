 ...
 * @since 1.0.0
 */
class Team_Three extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Team / Instructor 3( Grid / Carousel )', 'eduvibe-core' );
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'container', 'class', 'eduvibe-team-three-wrapper' );
        $this->add_render_attribute( 'container', 'class', 'eduvibe-team-three-' . esc_attr( $settings['display_type'] ) );
        $this->add_render_attribute( 'single-wrapper', 'class', 'eduvibe-team-three-single-' . esc_attr( $settings['display_type'] ) );
            ...
            echo '<div ' . $this->get_render_attribute_string( 'container' ) . '>';
                foreach ( $members as $key => $member ) :
                    ...
                    echo '<div ' . $this->get_render_attribute_string( 'single-wrapper' ) . '>';
                        echo '<div class="edu-instructor-grid edu-instructor-2">';
                            echo '<div class="edu-instructor">';
                                echo '<div class="inner">';
                                    echo '<div class="thumbnail">';
                                        ...
                                        echo '</a>';
                                    echo '</div>';
                                    echo '<div class="team-share-info">';
                            ...
                            echo '<div class="edu-instructor-grid edu-instructor-2">';
                                ...
                                echo '<div class="edu-instructor-info">';
                                    ...
                                    if ( 'yes' === $settings['enable_designation'] && ! empty( $job ) ) :
                                        echo '<span class="desc">' . esc_html( $job ) . '</span>';
                                    endif;
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
