 ...
 * @since 1.0.0
 */
class Events_One extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Events 1', 'eduvibe-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => __( 'Get Ticket', 'eduvibe-core' ),
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'container', 'class', 'eduvibe-event-wrapper' );
        if ( 'yes' === $settings['active_white_bg'] ) :
            $this->add_render_attribute( 'container', 'class', 'active-bg' );
        endif;
        if ( 'grid' === $settings['display_type'] ) :
            ...
            $this->add_render_attribute( 'single-wrapper', 'class', 'eduvibe-event-grid-item' );
        else :
            $this->add_render_attribute( 
                'container', 
                [
                    'class'                   => 'eduvibe-slider-item eduvibe-event-one-slider',
                            ...
                            echo '<div class="inner">';
                                echo '<div class="thumbnail">';
                                    ...
                                    if ( ! empty( $date  ) ) :
                                        echo '<div class="top-position status-group left-top">';
                                            echo '<span class="eduvibe-status">';
                                                echo esc_html( $date );
                                            echo '</span>';
                                        echo '</div>';
                                    endif;
                                ...
                                echo '<div class="content">';
                                    ...
                                    echo '<div class="read-more-btn">';
                                        echo '<a class="btn-transparent" href="' . esc_url( get_the_permalink() ) . '">' . esc_html( $settings['button_text'] ) . '<i class="icon-arrow-right-line-right"></i></a>';
                                    echo '</div>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
