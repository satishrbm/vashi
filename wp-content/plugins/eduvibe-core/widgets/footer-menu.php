...
class Footer_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Footer Menu', 'eduvibe-core' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'footer_menu_style',
            [
                'label' => __( 'Footer Menu', 'eduvibe-core' ),
        ...
        $this->add_responsive_control(
            'space_between',
            [
                'label'       => __( 'Space Between', 'eduvibe-core' ),
    ...
    protected function render() {
        ...
        $args = [
            'echo'        => false,
            'menu'        => $settings['menu'],
            'depth'       => apply_filters( 'eduvibe_footer_menu_depth', 1 ),
        ...
        $this->add_render_attribute( 'menu', 'class', 'eduvibe-nav-menu-wrapper' );
